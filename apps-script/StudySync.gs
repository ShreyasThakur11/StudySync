...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addSubMenu(SpreadsheetApp.getUi().createMenu('🤖  Automation (Phase 2)')
      .addItem('🔔  Setup Automation Triggers',  'setupPhase2Triggers')
      .addItem('🚫  Clear Automation Triggers',  'clearPhase2Triggers')
      .addSeparator()
      .addItem('🧪  Test Morning Reminder',      'sendDailyReminder')
      .addItem('🧪  Test Evening Follow-up',      'sendEveningFollowUp')
      .addItem('🧪  Test Weekly Summary',         'sendWeeklySummary'))
    .addSeparator()
